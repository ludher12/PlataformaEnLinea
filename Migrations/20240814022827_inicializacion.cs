    ...
    public partial class inicializacion : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_CoursePricings_PaymentOptions_PaymentOptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CourseSubscriptionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    PaymentOptionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseSubscriptions", x => x.CourseSubscriptionId);
                    table.ForeignKey(
                        name: "FK_CourseSubscriptions_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_CourseSubscriptions_PaymentOptions_PaymentOptionId",
                        column: x => x.PaymentOptionId,
                        principalTable: "PaymentOptions",
                        principalColumn: "PaymentOptionId",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiscussionForums_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseMaterials_ContentTypes_ContentTypeId",
                        column: x => x.ContentTypeId,
                        principalTable: "ContentTypes",
                        principalColumn: "ContentTypeId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_CourseMaterials_CourseModules_CourseModuleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LocalizedContentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CourseModuleId = table.Column<int>(type: "int", nullable: false),
                    LanguageId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocalizedContents", x => x.LocalizedContentId);
                    table.ForeignKey(
                        name: "FK_LocalizedContents_CourseModules_CourseModuleId",
                        column: x => x.CourseModuleId,
                        principalTable: "CourseModules",
                        principalColumn: "CourseModuleId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_LocalizedContents_Languages_LanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Payments_CoursePricings_CoursePricingId",
                        column: x => x.CoursePricingId,
                        principalTable: "CoursePricings",
                        principalColumn: "CoursePricingId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiscussionPosts_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DiscussionPosts_DiscussionForums_DiscussionForumId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ExamSubmissionId",
                        onDelete: ReferentialAction.NoAction);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseMaterials_ContentTypeId",
                table: "CourseMaterials",
                column: "ContentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseMaterials_CourseModuleId",
                table: "CourseMaterials",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursePricings_PaymentOptionId",
                table: "CoursePricings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseSubscriptions_PaymentOptionId",
                table: "CourseSubscriptions",
                column: "PaymentOptionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscussionForums_CourseId",
                table: "DiscussionForums",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscussionPosts_DiscussionForumId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocalizedContents_CourseModuleId",
                table: "LocalizedContents",
                column: "CourseModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_LocalizedContents_LanguageId",
                table: "LocalizedContents",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_CoursePricingId",
                table: "Payments",
